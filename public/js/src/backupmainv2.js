...
$(function() {
	...
	//CORS security error
		...
		document.getElementById('resize').addEventListener('click', getDimensions, false);
		document.getElementById('crop').addEventListener('click', getDimensions, false);
		...
		function cropAction(width, height) {
